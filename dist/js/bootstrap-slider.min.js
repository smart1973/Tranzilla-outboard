    ...
    (function(a) {
      function e(b, c) {
        ...
        if (
          ...
          var Q = N ? { passive: !0 } : !1;
          this.sliderElem.addEventListener("touchstart", this.touchstart, Q),
            this.sliderElem.addEventListener("touchmove", this.touchmove, Q);
        }
        if (
          ...
          if (
            ...
            var R = this._addTickListener(),
              ...
              T = R.addMouseLeave(this, this.handle1);
            (this.handleCallbackMap.handle1 = { mouseEnter: S, mouseLeave: T }),
              (S = R.addMouseEnter(this, this.handle2)),
              (T = R.addMouseLeave(this, this.handle2)),
      ...
      (d = function(a, b) {
        ...
        (d.prototype = {
          ...
          _removeTooltipListener: function(a) {
            this.handle1.removeEventListener(a, this.showTooltip, !1),
              this.handle2.removeEventListener(a, this.showTooltip, !1);
          },
          _removeSliderEventHandlers: function() {
            ...
            (this.handleCallbackMap = null),
              ...
              this.showTooltip && this._removeTooltipListener("focus"),
              this.hideTooltip && this._removeTooltipListener("blur"),
              this.showTooltip &&
          ...
          _layout: function() {
            ...
            if (this.options.range) {
              ...
              (n = this.options.formatter(this._state.value[0])),
                n <= 1000 ? this._setText(this.tooltipInner, n) : this._setText(this.tooltipInner, 'מעל 1.000 ₪'),
